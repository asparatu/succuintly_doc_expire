...
//Database entry point
  ...
  Future<Database> initializeDb() async {
    ...
    Database db = await openDatabase(p, version: 1, onCreate: _createDb);
    return db;
  }
  ...
  void _createDb(Database db, int version) async {
    await db.execute(
        'CREATE TABLE $tblDocs($docId INTEGER PRIMARY KEY, $docTitle TEXT, $docExpiration TEXT, ' +
            '$fqYear INTEGER, $fqHalfYear INTEGER, $fqQuarter INTEGER, $fqMonth INTEGER)');
  }
